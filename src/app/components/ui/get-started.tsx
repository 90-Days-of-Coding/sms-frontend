...
const Button = () => {
  ...
  return (
    <StyledWrapper>
      <animated.button
        style={spring}
        className="get-started flex items-center font-roboto font-[400] text-[1rem] px-4 py-4 md:p-5 border-none rounded-xl relative shadow-[0_0_1.5em_-.3em] shadow-[#3627ba] hover:shadow-[#3d8bff]
        active:shadow-[#3d8bff] active:scale-90 md:text-[1.5rem] md:rounded-2xl lg:text-[2rem]"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 32 32"
          className="w-[1.3rem] h-[1.3rem] rocket transition-transform mr-2 fill-[var(--foreground)] md:w-[2rem] md:h-[2rem]"
        >
